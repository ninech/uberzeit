class Summarize::User::Work
  ...
  def calculate
    @total = summarize_work_range
  end

  SUMMARIZE_ATTRIBUTES = [:range, :planned_work, :effective_worked, :effective_worked_by_type, :absent, :absent_by_type, :time_bonus, :overtime]

  def summarize_work_range
