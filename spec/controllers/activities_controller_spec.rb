  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved activity as @activity" do
        ...
        post :create, {:activity => { "activity_type" => "invalid value" }}, valid_session
        assigns(:activity).should be_a_new(Activity)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested activity" do
        ...
        Activity.any_instance.should_receive(:update_attributes).with({ "activity_type" => "" })
        put :update, {:id => activity.to_param, :activity => { "activity_type" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the activity as @activity" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Activity.any_instance.stub(:save).and_return(false)
        put :update, {:id => activity.to_param, :activity => { "activity_type" => "invalid value" }}, valid_session
        assigns(:activity).should eq(activity)
      end
