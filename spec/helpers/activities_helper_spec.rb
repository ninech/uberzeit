...
describe ActivitiesHelper do
  describe '#activity_source_information' do
    ...
    context 'activity with redmine link' do
      ...
      it { should eq '.redmine: <a href="/issues/1337">#1337</a>' }
    end
    ...
    context 'activity with redmine and otrs link' do
      ...
      it { should eq '.otrs: <a href="/otrs/index.pl?Action=AgentTicketZoom&amp;TicketNumber=42">#42</a> und .redmine: <a href="/issues/1337">#1337</a>' }
    end
  end
end
