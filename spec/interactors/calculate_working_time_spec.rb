...
describe CalculateWorkingTime do
  ...
  def vacation(start_date, end_date)
    FactoryGirl.create(:absence, start_date: start_date.to_date, end_date: end_date.to_date, time_type: :vacation, user: user)
  end

  it 'calculates the working time for a date' do
    work '2013-03-12 9:00:00', '2013-03-12 18:00:00'
    CalculateWorkingTime.new(user.time_sheet, date).total.should eq(9.0.hours)
  end

  it 'calculates the working time for a range' do
    work '2013-03-12 9:00:00', '2013-03-12 18:00:00'
    vacation '2013-03-13', '2013-03-13'
    CalculateWorkingTime.new(user.time_sheet, range).total.should eq(9.hours + 8.5.hours)
  end
end
