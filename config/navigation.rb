...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :timesheet, t('navigation.time_tracking'), time_sheet_path(current_user.current_time_sheet), highlights_on: %r!\A/(time_sheets/\d+|users/\d+/activities)(/date/[\w-]+)?\z! do |second|
      ...
      second.item :timesheet, t('navigation.timesheet'), show_date_time_sheet_path(current_user.current_time_sheet, date: @day), highlights_on: %r!\A/time_sheets/\d+(/date/[\w-]+)?\z!
      second.item :activities, t('navigation.activities'), show_date_user_activities_path(current_user, date: @day), highlights_on: %r!\A/users/\d+/activities(/date/[\w-]+)?\z!
    end
