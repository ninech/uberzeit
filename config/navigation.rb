...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :reports, t('navigation.reports'), reports_overview_user_path(current_user), highlights_on: %r!\A/reports! do |second|
      ...
      second.item :my_absence, t('navigation.sub.reports.my_absence'), reports_absences_user_year_path(current_user, Date.current.year), highlights_on: %r!\A/reports/absences/users/\d*!
